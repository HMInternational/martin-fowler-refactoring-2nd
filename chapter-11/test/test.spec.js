...
const { findMiscreant, alertForMiscreant } = require('../part.01-Separate_Query_From_Modifier/after');
...
describe('part.08-Replace_Constructor_With_Factory_Function', () => {
  ...
  describe('Refactoring code', () => {
    const { createEmployee, createEngineer } = require('../part.08-Replace_Constructor_With_Factory_Function/after');
    const document = {
      name: 'ham',
      empType: 'E',
      leadEngineer: 's',
